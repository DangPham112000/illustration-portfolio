export default [
  {
    id: "p1",
    title: "Two girls with two lumps",
...
This illustration belongs to my series named “Weave - Plain & Mystic” for an exhibition.`,
    priImg: "/img/magic/P1___two_lumps/v1_2_cuc_buou_800x800@1.5x.jpg",
  ...
  {
    id: "p2",
    title: "Getting married to a Toad",
    description: `A man met a Toad in a paddy field. After a while getting to know each other, he decided to get married to the Toad although everyone was laughing at him and his wife.
...
This illustration belongs to my series named “Weave - Plain & Mystic” for an exhibition.`,
    priImg:
      "/img/magic/P2___Toad/v1_project/v1_Nguoi_lay_coc_scene1_800x800.jpg",
    square: [
      "/img/magic/P2___Toad/v2_project_detail/v2_Nguoi_lay_coc_scene1_800x800.jpg",
      "/img/magic/P2___Toad/v2_project_detail/v2_Nguoi_lay_coc_scene2_800x800@1.5x.jpg",
    ],
    full: [
      "/img/magic/P2___Toad/v3_zoom_in/v3_Nguoi_lay_coc_scene1_1080H@1.25x.jpg",
...

  {
    id: "p3",
    title: "A lawsuit",
    description: `“Ông Bụt” (Buddha) is trying to adjudicate a case.
...
This illustration belongs to my series named “Weave - Plain & Mystic” for an exhibition.`,
    priImg:
      "/img/magic/P3___Lawsuit/v1_project/v1_Vukienchauchau_scene_1_800x800@1.5x.jpg",

    square: [
      "/img/magic/P3___Lawsuit/v2_project_detail/v2_Vukienchauchau_scene_1_800x800@1.5x.jpg",
      "/img/magic/P3___Lawsuit/v2_project_detail/v2_Vukienchauchau_scene2_ongBut_800x800@1.5x.jpg",
    ],
    full: [
      "/img/magic/P3___Lawsuit/v3_zoom_in/v3_Vukienchauchau_scene_1_1920w.jpg",
  ...
  {
    id: "p4",
    title: "Beautiful flowers that bloom in a porcelain pot",
    description: `A porcelain pot with a broken handle is abandoned in a secluded land. When the winter comes, two butterflies are looking for a place to hide from the cold weather. Luckily, the pot is a perfect shelter, warm and dry enough for them to survive through this harsh season.
But when the winter passes, the butterflies fly far away. The pot is so upset, and he thinks no one wants to make friends and stay with him forever. In his most desperate moment, a little girl appears and decides to bring him home. She cleans the pot inside out and also sows some seeds in his body. A short time later, strangely enough, he feels something is moving in his body. And booooom… surprisingly, many beautiful flowers are blooming from the pot. Since then, he has lived happily with his new friends!`,
    priImg:
      "/img/magic/P4___Porcelain/v1___project/v1_magic_chiec_am_sanh_800x800@1.5x.jpg",

    square: [
      "/img/magic/P4___Porcelain/v2____project_detail_1_1/v2_chiec_am_sanh_0_title.png",
      "/img/magic/P4___Porcelain/v2____project_detail_1_1/v2_chiec_am_sanh_1_800x800@1.5x.jpg",
      "/img/magic/P4___Porcelain/v2____project_detail_1_1/v2_chiec_am_sanh_2_800x800@1.5x.jpg",
      "/img/magic/P4___Porcelain/v2____project_detail_1_1/v2_chiec_am_sanh_3_800x800@1.5x.jpg",
      "/img/magic/P4___Porcelain/v2____project_detail_1_1/v2_chiec_am_sanh_4_800x800@1.5x.jpg",
      "/img/magic/P4___Porcelain/v2____project_detail_1_1/v2_chiec_am_sanh_5_800x800@1.5x.jpg",
      "/img/magic/P4___Porcelain/v2____project_detail_1_1/v2_chiec_am_sanh_6_theEnd.png",
    ],
    full: [
      "/img/magic/P4___Porcelain/v3___project_zoom_in/v3_chiec_am_sanh_0_title.png",
      "/img/magic/P4___Porcelain/v3___project_zoom_in/v3_chiec_am_sanh_1_1920w.jpg",
      "/img/magic/P4___Porcelain/v3___project_zoom_in/v3_chiec_am_sanh_2_1920w.jpg",
      "/img/magic/P4___Porcelain/v3___project_zoom_in/v3_chiec_am_sanh_3_1920w.jpg",
      "/img/magic/P4___Porcelain/v3___project_zoom_in/v3_chiec_am_sanh_4_1920w.jpg",
      "/img/magic/P4___Porcelain/v3___project_zoom_in/v3_chiec_am_sanh_5_1920w.jpg",
  ...
  {
    id: "p5",
    title: "Fairies in the garden",
    description: `Little fairies hiding in your garden may bring you some good luck! Should you gently look for them? ^_^`,
    priImg: "/img/magic/P5___Faries/v1___project/v1_Nang_tien_hoa_1080H.jpg",

    square: [
      "/img/magic/P5___Faries/v2_project_detail/v2_Nang_tien_hoa_1080H@2x.jpg",
      "/img/magic/P5___Faries/v2_project_detail/v2_Ngoi_nghi_chut_nha_1080H@2x.jpg",
      "/img/magic/P5___Faries/v2_project_detail/v2_Ngu_trong_hoa_1080H@2x.jpg",
      "/img/magic/P5___Faries/v2_project_detail/v2_Tam_hoa_1080H@2x.jpg",
    ],
    full: [
      "/img/magic/P5___Faries/v3_zoom_in/v3_Nang_tien_hoa_1080H@2x.jpg",
      "/img/magic/P5___Faries/v3_zoom_in/v3_Ngoi_nghi_chut_nha_1080H@2x.jpg",
      "/img/magic/P5___Faries/v3_zoom_in/v3_Ngu_trong_hoa_1080H@2x.jpg",
...

  {
    ...
    priImg: "/img/magic/P6___Fly_high_Dad/v1_Ba_va_Con_gai_800x800@2x.jpg",
...

  {
    ...
    priImg:
      "/img/magic/P7___Mom_How_to_cook/v1_Mom_How_to_cook_800x800@1.5x.jpg",

    square: [
      "/img/magic/P7___Mom_How_to_cook/v2_Mom_How_to_cook_800x800@1.5x.jpg",
    ],
    full: [
...

  {
    ...
    priImg:
      "/img/magic/P8___You_are_my_princess/v1_You_are_my_princess_800x800@1.5x.jpg",

    square: [
      "/img/magic/P8___You_are_my_princess/v2_You_are_my_princess_800x800@1.5x.jpg",
    ],
    full: [
...

  {
    ...
    priImg:
      "/img/magic/P9___Beautiful_sunrise/v1_Beautiful_sunrise_800x800@1.5x.jpg",

    square: [
      "/img/magic/P9___Beautiful_sunrise/v2_Beautiful_sunrise_800x800@1.5x.jpg",
    ],
    full: [
...
`,
    priImg:
      "/img/magic/P10___Children_Party/v1_a_Childrens_party_800x800@1.5x.jpg",

    square: [
      "/img/magic/P10___Children_Party/v2_a_Childrens_party_800x800@1.5x.jpg",
    ],
    full: [
...
`,
    priImg: "/img/magic/P11___Crocodile/v1_CROCODILE_800x800@1.5x.jpg",
...

  {
    ...
    priImg: "/img/magic/P12___Dragon/v1_littledragon_800x800@2x.jpg",
...

  {
    ...
    priImg:
      "/img/magic/P13___Mom_rain_on_your_shoulder/v1_mom_rainisonyourshoulder_800x800@1.5x.jpg",

    square: [
      "/img/magic/P13___Mom_rain_on_your_shoulder/v2_mom_rainisonyourshoulder_800x800@1.5x.jpg",
    ],
    full: [
...

  {
    ...
    priImg: "/img/magic/P14___Mouse/v1_mouse_on_my_head_800x800@1.5x.jpg",
...

  {
    ...
    priImg:
      "/img/magic/P15___The_Rescue/v1_Project/v1_TheRescue_1_800x800@1.5x.jpg",

    square: [
      "/img/magic/P15___The_Rescue/v2_Project_detail/v2_TheRescue_1_800x800@1.5x.jpg",
      "/img/magic/P15___The_Rescue/v2_Project_detail/v2_TheRescue_2_800x800@2x.jpg",
      "/img/magic/P15___The_Rescue/v2_Project_detail/v2_TheRescue_4_800x800@2x.jpg",
      "/img/magic/P15___The_Rescue/v2_Project_detail/v2_TheRescue_5_800x800@2x.jpg",
    ],
    full: [
      "/img/magic/P15___The_Rescue/v3_Zoom_inb/v3_TheRescue_1_1080H@1.25x.jpg",
      "/img/magic/P15___The_Rescue/v3_Zoom_inb/v3_TheRescue_2_1080H@1.25x.jpg",
...

  {
    ...
    square: [
      "/img/magic/P16___Trina_Julie_flowers/v2_T_J_Flowers_800x800px@1.5x.jpg",
    ],
    full: [
